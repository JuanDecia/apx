/*
  ...
  El objetivo es verificar los videos que aun no fueron vistos mediante
  distintos métodos de iteración.
...
while ( i < videos.length ) {
  ...
  if ( !vistosById[video.id] ) {
    console.log(`No viste el video: ${video.title}.`);
  }
